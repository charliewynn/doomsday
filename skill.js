...
const handlers = { 
	...
	'explain' : function(){ 
			const speechOutput = 
				...
				"For odd numbered months you can Remember the phrase <break time='30ms' /><prosody rate='slow'>'I work nine to five, at seven eleven'</prosody> to help you remember The fifth of the ninth month, September 5th, as well as the ninth of the fifth month, May 9th, are both " + getDoomsday() + ". <break time='75ms' /> same with the 7th of the eleventh month, and the eleventh of the 7th month. So November 7th and July 11th. <break time='150ms' /> " + 
		...
		if(intent.slots.date.value) { 
			...
			if(ans == guess){ 
				...
				if(attrs.badGuesses < 2){ 
					attrs.badGuesses++; 
					resp = "Sorry, wrong answer.  Try again or say 'I give up' and I'll walk you through it"; 
